package net.qiuflms.enchantingsystemrework.block.entity.custom;
...
public class CustomEnchantingBlockEntity extends BlockEntity implements Nameable {

    private static final Text CONTAINER_NAME_TEXT = Text.translatable(String.join(".", "container", EnchantingSystemRework.MOD_ID, "custom_enchant"));
    public int ticks;
    ...
    public CustomEnchantingBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.CUSTOM_ENCHANTING_TABLE, pos, state);
    }
    ...
    public static void tick(World world, BlockPos pos, BlockState state, CustomEnchantingBlockEntity blockEntity) {
