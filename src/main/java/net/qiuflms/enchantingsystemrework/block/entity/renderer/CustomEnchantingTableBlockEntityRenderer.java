package net.qiuflms.enchantingsystemrework.block.entity.renderer;
...
public class CustomEnchantingTableBlockEntityRenderer implements BlockEntityRenderer<CustomEnchantingBlockEntity, CustomEnchantingTableBlockEntityRenderState> {
    ...
    @Override
    public CustomEnchantingTableBlockEntityRenderState createRenderState() {
        return new CustomEnchantingTableBlockEntityRenderState();
    }

    public void updateRenderState(
            CustomEnchantingBlockEntity enchantingTableBlockEntity,
            CustomEnchantingTableBlockEntityRenderState enchantingTableBlockEntityRenderState,
            float f,
            Vec3d vec3d,
