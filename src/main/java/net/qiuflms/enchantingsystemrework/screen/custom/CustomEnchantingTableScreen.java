...
public class CustomEnchantingTableScreen extends HandledScreen<CustomEnchantingTableScreenHandler> {
    ...
    public CustomEnchantingTableScreen(CustomEnchantingTableScreenHandler handler, PlayerInventory inventory, Text title) {
